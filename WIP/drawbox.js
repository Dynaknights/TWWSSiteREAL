...
const GOOGLE_FORM_ID="1vTQMAoDiwIOTMx720GQWpmAL3CBTxN1UU0GPyR-14aU";
const ENTRY_ID="entry.415695918";
const NAME_ID="entry.1217667036";
...
const GOOGLE_SHEET_ID="1PL_jKIu0qjIqOgY-QeH5THm85JqKkF6IWrwTmCyr0Bk";

// optional I recommend getting your own client ID https://apidocs.imgur.com/ */
const CLIENT_ID = "683200d14d127a3c9e36cb92";
...
// i kept accidentally clearing my image when i meant to do /undo haha
function Clear() {

  if (confirm("Are you sure you want to clear your canvas? This can not be undone.") == true) {
  context.fillStyle = "white";
...
document.getElementById("submit").addEventListener("click", async function () {
  ...
  if (start_index <= -1) { alert("You can't submit an empty canvas!"); }
  ...
  try {
    ...
    if (!data.success) throw new Error("File Garden upload failed");
    ...
    if(IMAGE_APPROVAL){
      alert("Image submitted successfully! It'll be posted once it's approved.");
    }
    else {
